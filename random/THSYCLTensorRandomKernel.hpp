...
using ACC_1D_RW_G = accessor<uint8_t, 1, access::mode::read_write, access::target::global_buffer>;
using ACC_1D_W_G = accessor<uint8_t, 1, access::mode::read_write, access::target::global_buffer>;
